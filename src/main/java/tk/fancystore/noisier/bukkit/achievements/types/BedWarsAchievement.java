...
public class BedWarsAchievement extends Achievement {
  ...
  public static void setupAchievements() {
    Achievement.addAchievement(
        new BedWarsAchievement(new CoinsReward(100), "2k1", "Assasino (Solo)", "&7Abata um total de %reach%\n&7jogadores para receber:\n \n &8• &6100 Coins",
            50, "1v1kills"));
    Achievement.addAchievement(
        new BedWarsAchievement(new CoinsReward(500), "2k2", "Assasino Mestre (Solo)", "&7Abata um total de %reach%\n&7jogadores para receber:\n \n &8• &6500 Coins",
            250, "1v1kills"));
    Achievement.addAchievement(
        new BedWarsAchievement(new CoinsReward(250), "2w1", "Vitorioso (Solo)", "&7Vença um total de %reach%\n&7partidas para receber:\n \n &8• &6250 Coins",
            50, "1v1wins"));
    Achievement.addAchievement(
        new BedWarsAchievement(new CoinsReward(1000), "2w2", "Vitorioso Mestre (Solo)", "&7Vença um total de %reach%\n&7partidas para receber:\n \n &8• &61.000 Coins",
            200, "1v1wins"));
    Achievement.addAchievement(
        new BedWarsAchievement(new CoinsReward(250), "2d1", "Destruidor (Solo)", "&7Vença um total de %reach%\n&7partidas para receber:\n \n &8• &6250 Coins",
            250, "1v1bedsdestroyeds"));
    Achievement.addAchievement(
        new BedWarsAchievement(new CoinsReward(1000), "2d2", "Destruidor Mestre (Solo)", "&7Vença um total de %reach%\n&7partidas para receber:\n \n &8• &61.000 Coins",
            1000, "1v1bedsdestroyeds"));
    Achievement.addAchievement(
        new BedWarsAchievement(new CoinsReward(250), "2g1", "Persistente (Solo)", "&7Jogue um total de %reach%\n&7partidas para receber:\n \n &8• &6250 Coins",
            1000, "1v1games"));
    Achievement.addAchievement(
        new BedWarsAchievement(new CoinsReward(100), "4k1", "Assasino (Duplas)", "&7Abata um total de %reach%\n&7jogadores para receber:\n \n &8• &6100 Coins",
            50, "2v2kills"));
    Achievement.addAchievement(
        new BedWarsAchievement(new CoinsReward(500), "4k2", "Assasino Mestre (Duplas)", "&7Abata um total de %reach%\n&7jogadores para receber:\n \n &8• &6500 Coins",
            250, "2v2kills"));
    Achievement.addAchievement(
        new BedWarsAchievement(new CoinsReward(250), "4w1", "Vitorioso (Duplas)", "&7Vença um total de %reach%\n&7partidas para receber:\n \n &8• &6250 Coins",
            50, "2v2wins"));
    Achievement.addAchievement(
        new BedWarsAchievement(new CoinsReward(1000), "4w2", "Vitorioso Mestre (Duplas)", "&7Vença um total de %reach%\n&7partidas para receber:\n \n &8• &61.000 Coins",
            200, "2v2wins"));
    Achievement.addAchievement(
        new BedWarsAchievement(new CoinsReward(250), "4d1", "Destruidor (Duplas)", "&7Vença um total de %reach%\n&7partidas para receber:\n \n &8• &6250 Coins",
            250, "2v2bedsdestroyeds"));
    Achievement.addAchievement(
        new BedWarsAchievement(new CoinsReward(1000), "4d2", "Destruidor Mestre (Duplas)", "&7Vença um total de %reach%\n&7partidas para receber:\n \n &8• &61.000 Coins",
            1000, "2v2bedsdestroyeds"));
    Achievement.addAchievement(
        new BedWarsAchievement(new CoinsReward(250), "4g1", "Persistente (Duplas)", "&7Jogue um total de %reach%\n&7partidas para receber:\n \n &8• &6250 Coins",
            1000, "2v2games"));
    Achievement.addAchievement(
        new BedWarsAchievement(new TitleReward("bwk"), "bwk", "Asasino a espreita", "&7Abata um total de %reach%\n&7jogadores para receber:\n \n &8• &fTítulo: &cDestruidor de Sonhos",
            500, "2v2kills", "2v2kills"));
    Achievement.addAchievement(
    ...
    Achievement.addAchievement(
        new BedWarsAchievement(new TitleReward("bwp"), "bwp", "Freddy Krueger", "&7Destrua um total de %reach%\n&7camas para receber:\n \n &8• &fTítulo: &4Pesadelo", 2000,
            "1v1bedsdestroyeds", "2v2bedsdestroyeds"));
  }
