...
import tk.fancystore.noisier.bukkit.player.enums.PartyRequests;
  ...
  public void perform(CommandSender sender, String label, String[] args) {
    ...
    if (label.equalsIgnoreCase("p")) {
      ...
      if (action.equalsIgnoreCase("abrir")) {
        ...
        if (Profile.getProfile(action).getPreferencesContainer().getPartyRequests() == PartyRequests.DESATIVADO) {
          player.sendMessage("§c" + Manager.getCurrent(action) + " não está aceitando pedidos de party.");
          return;
        }
