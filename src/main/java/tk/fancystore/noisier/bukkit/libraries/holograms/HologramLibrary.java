package tk.fancystore.noisier.bukkit.libraries.holograms;
...
public class HologramLibrary {
  ...
  public static final CoreLogger LOGGER = Core.getInstance().getCoreLogger().getModule("HOLOGRAMS");
  ...
  public static void setupHolograms(NBukkit pl) {
    if (plugin != null) {
      return;
    }
