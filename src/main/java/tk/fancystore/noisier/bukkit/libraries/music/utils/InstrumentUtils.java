...
import tk.fancystore.noisier.bukkit.libraries.music.model.NoteSound;
...
public class InstrumentUtils {
	...
	public static org.bukkit.Sound getInstrument(byte instrument) {
		return NoteSound.getFromBukkitName(getInstrumentName(instrument));
	}
	...
	public static String getInstrumentName(byte instrument) {
		switch (instrument) {
			case 1:
				return NoteSound.getFromBukkitName("BLOCK_NOTE_BLOCK_BASS").name();
			case 2:
				return NoteSound.getFromBukkitName("BLOCK_NOTE_BLOCK_BASEDRUM").name();
			case 3:
				return NoteSound.getFromBukkitName("BLOCK_NOTE_BLOCK_SNARE").name();
			case 4:
				return NoteSound.getFromBukkitName("BLOCK_NOTE_BLOCK_HAT").name();
			case 5:
				return NoteSound.getFromBukkitName("BLOCK_NOTE_BLOCK_GUITAR").name();
			case 6:
				return NoteSound.getFromBukkitName("BLOCK_NOTE_BLOCK_FLUTE").name();
			case 7:
				return NoteSound.getFromBukkitName("BLOCK_NOTE_BLOCK_BELL").name();
			case 8:
				return NoteSound.getFromBukkitName("BLOCK_NOTE_BLOCK_CHIME").name();
			case 9:
				return NoteSound.getFromBukkitName("BLOCK_NOTE_BLOCK_XYLOPHONE").name();
			case 10:
				return NoteSound.getFromBukkitName("BLOCK_NOTE_BLOCK_IRON_XYLOPHONE").name();
			case 11:
				return NoteSound.getFromBukkitName("BLOCK_NOTE_BLOCK_COW_BELL").name();
			case 12:
				return NoteSound.getFromBukkitName("BLOCK_NOTE_BLOCK_DIDGERIDOO").name();
			case 13:
				return NoteSound.getFromBukkitName("BLOCK_NOTE_BLOCK_BIT").name();
			case 14:
				return NoteSound.getFromBukkitName("BLOCK_NOTE_BLOCK_BANJO").name();
			case 15:
				return NoteSound.getFromBukkitName("BLOCK_NOTE_BLOCK_PLING").name();
			default:
				return NoteSound.getFromBukkitName("BLOCK_NOTE_BLOCK_HARP").name();
		}
	}
