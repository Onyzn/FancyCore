...
import tk.fancystore.noisier.bukkit.menus.profile.boosters.MenuBoostersList;
...
public class MenuBoosters extends PlayerMenu {
  ...
  public MenuBoosters(Profile profile) {
    ...
    this.setItem(30, BukkitUtils.deserializeItemStack("INK_SACK:1 : 1 : name>&cVoltar"));
    this.setItem(31, BukkitUtils.deserializeItemStack(
        "PAPER : 1 : name>&aMultiplicadores de Crédito : lore>&7Os Multiplicadores são acumulativos. Quanto mais\n&7multiplicadores ativos, maior será o bônus recebido.\n \n&fMultiplicadores Gerais:\n" + network + "\n \n" + result));
