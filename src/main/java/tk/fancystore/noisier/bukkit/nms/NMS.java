package tk.fancystore.noisier.bukkit.nms;
...
import tk.fancystore.noisier.bukkit.nms.v1_8_R3.NMS1_8R3;
...
public class NMS {
  ...
  public static final CoreLogger LOGGER = Core.getInstance().getCoreLogger().getModule("NMS");
