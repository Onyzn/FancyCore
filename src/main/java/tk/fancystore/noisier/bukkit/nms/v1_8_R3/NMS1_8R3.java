package tk.fancystore.noisier.bukkit.nms.v1_8_R3;
...
import tk.fancystore.noisier.bukkit.libraries.npclib.api.npc.NPCAnimation;
...
import tk.fancystore.noisier.bukkit.libraries.npclib.npc.skin.SkinnableEntity;
import tk.fancystore.noisier.bukkit.nms.interfaces.INMS;
import tk.fancystore.noisier.bukkit.nms.interfaces.entity.IArmorStand;
import tk.fancystore.noisier.bukkit.nms.interfaces.entity.IItem;
import tk.fancystore.noisier.bukkit.nms.interfaces.entity.ISlime;
import tk.fancystore.noisier.bukkit.nms.v1_8_R3.entity.EntityArmorStand;
import tk.fancystore.noisier.bukkit.nms.v1_8_R3.entity.EntityItem;
import tk.fancystore.noisier.bukkit.nms.v1_8_R3.entity.EntitySlime;
import tk.fancystore.noisier.bukkit.nms.v1_8_R3.entity.*;
import tk.fancystore.noisier.bukkit.nms.v1_8_R3.utils.PlayerlistTrackerEntry;
import tk.fancystore.noisier.bukkit.nms.v1_8_R3.utils.UUIDMetadataStore;
...
public class NMS1_8R3 implements INMS {
  ...
  public NMS1_8R3() {
    ...
    CLASS_TO_NAME.get(null).put(EntityStand.class, "FancyCore-EntityStand");
    CLASS_TO_ID.get(null).put(EntityArmorStand.class, 30);
    CLASS_TO_NAME.get(null).put(EntityArmorStand.class, "FancyCore-ArmorStand");
    CLASS_TO_ID.get(null).put(EntitySlime.class, 55);
    CLASS_TO_NAME.get(null).put(EntitySlime.class, "FancyCore-Slime");
    CLASS_TO_ID.get(null).put(EntityItem.class, 1);
    CLASS_TO_NAME.get(null).put(EntityItem.class, "FancyCore-Item");
