package tk.fancystore.noisier.bukkit.player.scoreboard;
...
import tk.fancystore.noisier.bukkit.player.scoreboard.scroller.ScoreboardScroller;
import tk.fancystore.noisier.utils.StringUtils;

public abstract class NScoreboard {
  ...
  public NScoreboard add(int line) {
    return add(line, "");
  }

  public NScoreboard add(int line, String name) {
  ...
  public NScoreboard remove(int line) {
    if (line > 15 || line < 1 || this.teams == null) {
      return this;
    }
  ...
  public NScoreboard to(Player player) {
  ...
  public NScoreboard display(String display) {
  ...
  public NScoreboard scroller(ScoreboardScroller ss) {
    this.scroller = ss;
    return this;
  }

  public NScoreboard health() {
    this.health = !health;
    if (this.scoreboard != null) {
      if (!this.health) {
