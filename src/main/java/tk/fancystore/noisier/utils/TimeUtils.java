...
public class TimeUtils {
  ...
  /**
   * Retorna o mês da data atual, ultil para fins
   * comparativos.
   *
   * @return Exemplo: '1/2020'
   */
  ...
  /**
   * Analisa se a data atual é de halloween.
   *
   * @return TRUE caso seja, FALSE caso não.
   */
  public static boolean isHalloween() {
    Calendar cl = Calendar.getInstance();
    return (cl.get(Calendar.MONTH) == Calendar.OCTOBER && (cl.get(Calendar.DATE) == 30 || cl.get(Calendar.DATE) == 31));
  }
