...
public enum EnumSound {
  ...
  DIG_WOOL("DIG_WOOL", "BLOCK_SNOW_DIG"),
  DIG_GRASS("DIG_GRASS", "BLOCK_GRASS_DIG"),
  DIG_GRAVEL("DIG_GRAVEL", "BLOCK_GRAVEL_DIG"),
  DIG_SAND("DIG_SAND", "BLOCK_SAND_DIG"),
  DIG_SNOW("DIG_SNOW", "BLOCK_SNOW_DIG"),
  DIG_STONE("DIG_STONE", "BLOCK_STONE_DIG"),
  DIG_WOOD("DIG_WOOD", "BLOCK_WOOD_DIG"),
